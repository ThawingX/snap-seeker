  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-md rounded-none rounded-b-xl bg-white p-4 md:p-8 dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="group/btn relative block h-10 w-full rounded-md bg-gradient-to-br from-cyan-500 to-cyan-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:from-cyan-600 dark:to-cyan-700"
          type="submit"
        >
          Log in &rarr;
          <BottomGradient />
